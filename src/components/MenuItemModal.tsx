      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="space-y-4">
          <div className="flex flex-col items-center space-y-2">
            <div className="w-full h-48 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center overflow-hidden">
              {previewImage ? (
                <div className="relative w-full h-full group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <label className="cursor-pointer text-white px-4 py-2 rounded-md bg-gray-800 hover:bg-gray-700">
                      Change Image
                      <input
                        type="file"
                        accept="image/*"
          ...
          <div className="flex justify-end space-x-2">
            ...
            <button
              type="button"
              onClick={() => {
                // console.log('Modal 提交時的 item:', item);
                onSubmit();
              }}
